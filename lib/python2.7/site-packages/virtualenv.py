...
def copyfile(src, dest, symlink=True):
    if not os.path.exists(src):
        # Some bad symlink in the FizzBuzzKata
...
def make_relative_path(source, dest, dest_is_directory=True):
    ...
    being referred to from the filename source.
        ...
        ...                    FizzBuzzKata)
        '../FizzBuzzKatather-place/src/Directory'
        >>> mFizzBuzzKata_relative_path('/usr/share/something/a-file.pth',
        ...                    FizzBuzzKata)
        '../../../home/useFizzBuzzKatarc/Directory'
        >>> make_relative_pFizzBuzzKata('/usr/share/a-file.pth', '/usr/share/')
        './'
    """
